...
class MultiModeSeq2SeqModel2(nn.Module):
    ...
    def forward(self, x, image_features):
        ...
        # 模态融合
        fused = torch.stack([encoded.transpose(1, 2), image_expand_features.transpose(1, 2)],
                            dim=-2)  # (batch_size, window_size, 2, hidden_dim)
...
def main(
    ...
    model = MultiModeSeq2SeqModel2(input_size, num_classes, window_size,
