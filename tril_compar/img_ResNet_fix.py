...
class ResNetEncoder(nn.Module):
    def __init__(self, pretrained=False, output_dim=256, resnet_type="resnet18",
                 weight_path=None):
...
class ResNetSeq2Seq(nn.Module):
    def __init__(self,num_classes, window_size, resnet_feature_dim=256,resnet_type="resnet50",weight_path=None):
        super(ResNetSeq2Seq, self).__init__()
        self.window_size = window_size

        self.image_feature_extractor = ResNetEncoder(pretrained=False, resnet_type=resnet_type,
...
def main(
    ...
    model = ResNetSeq2Seq(num_classes, window_size,
                          resnet_feature_dim=hidden_dim,
                          resnet_type="resnet18",
                          weight_path="../img_encoder_weight/resnet18/model.safetensors")
...
if __name__ == '__main__':
    ...
    metrics_df.to_csv(f'./20_tril_result/img_Res_{window_size}_metrics.csv',
                      index=False)
